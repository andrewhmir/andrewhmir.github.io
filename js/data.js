...
const PORTFOLIO = {
  ...
  projects: [
    ...
    },
    {
      ...
      overview: {
        image: "files/PlaceHolder.png",
        text: "SATLearn started because I was studying for the SAT and ran into a pretty specific problem.\n\nBluebook had realistic full-length practice tests, but there were only a limited number of them. There was also a much larger question bank, but it didn't really give me the same experience as taking an actual timed test. I wanted more practice tests without having to reuse the same ones over and over.\n\nSo I built one.\n\nI took over 3,000 SAT questions and used OCR to turn them into a structured question bank, then built an open-source platform that could generate full-length practice tests from them. The goal was simple: get as much realistic practice as I needed without running out of official-style tests.\n\nI originally built SATLearn just so I could study for my own SAT. But it also became another example of something I've found myself doing repeatedly — when the tool I need doesn't quite exist, I usually end up building it myself."
      },
      team: {
        image: "files/PlaceHolder.png",
        text: [
